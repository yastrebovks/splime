...
apidoc_modules = [
    {
        "path": "../../src/spl",
        "destination": "api",
        # The implementation lives in private modules (spl._client,
        # spl.core._common); spl.client / spl.core.common are compatibility
        # warning shims. Document the real modules and skip the shims so builds
        # stay warning-free.
